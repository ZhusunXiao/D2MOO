...
struct PacketList {
	...
	typedef struct FAKEFILETIME
{
  /* 0x0000 */ uint32_t dwLowDateTime;
  /* 0x0004 */ uint32_t dwHighDateTime;
} FAKEFILETIME; /* size: 0x0008 */
...
struct D2ClientStrc
{
	...
	FAKEFILETIME nSaveCreationTimestamp;			//0x190
